...
if (get_option('leafletmapsmarker_version_pro') == '2.3' ) {
	...
	//info: re-add latest install-update-transient so routine is not run twice
	set_transient( 'leafletmapsmarker_install_update_cache_vp231', 'execute install and update-routine only once a day', 60*60*24 );
}
