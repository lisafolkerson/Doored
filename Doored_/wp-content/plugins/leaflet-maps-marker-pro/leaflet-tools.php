...
if (!empty($action)) {
	...
	elseif ($action == 'gpx-url') {
		if ( (lmm_isValidURL( $_POST['marker-gpx-url'] )) || ($_POST['marker-gpx-url'] == NULL) ) {	
			if ($_POST['marker-gpx-url-layer'] == 'all') {
				...
				$result = $wpdb->prepare( "UPDATE `$table_name_markers` SET `gpx_url` = %d WHERE `layer` = %d", trim($_POST['marker-gpx-url']), intval($_POST['marker-gpx-url-layer']) );
			}
			$wpdb->query( $result );
			$wpdb->query( "OPTIMIZE TABLE `$table_name_markers`" );
			echo '<p><div class="updated" style="padding:10px;">' . __('The URL to GPX track for the selected markers has been successfully updated','lmm') . '</div><br/><a class="button-secondary" href="' . LEAFLET_WP_ADMIN_URL . 'admin.php?page=leafletmapsmarker_tools">' . __('Back to Tools', 'lmm') . '</a></p>';
		} else {
	...
	elseif ($action == 'gpx-panel') {
		if ($_POST['marker-gpx-panel-layer'] == 'all') {
			...
			$result = $wpdb->prepare( "UPDATE `$table_name_markers` SET `gpx_panel` = %d WHERE `gpx_url` != '' AND `layer` = %d", $_POST['gpx-panel'], intval($_POST['marker-gpx-panel-layer']) );
		}
		$wpdb->query( $result );
		$wpdb->query( "OPTIMIZE TABLE `$table_name_markers`" );
	...
	<table class="widefat" style="width:100%;height:100px;">
		...
		<tr>
			<td style="vertical-align:top;">
				...
				echo '<input style="font-weight:bold;margin:10px 0;" class="button button-primary" type="submit" name="update-settings" value="' . __('update settings','lmm') . ' &raquo;" onclick="return confirm(\'' . __('Do you really want to update your settings?','lmm') . '\')" />';
	...
	<table class="widefat fixed" style="width:auto;">
		...
		<tr>
			...
			<td>
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="mass_asign-submit" value="<?php _e('move markers','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to move the selected markers?','lmm') ?>')" />
			</td>
		</tr>
	</table>
	</form>
	...
	<table class="widefat fixed" style="width:auto;">
		...
		<tr>
			...
			<td style="vertical-align:middle;text-align:center;" class="lmm-border">
				...
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="basemap-submit" value="<?php _e('change basemap','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the basemap for the selected markers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;text-align:center;" class="lmm-border">
				...
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="overlays-submit" value="<?php _e('change overlay status','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the overlay status for the selected markers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;text-align:center;" class="lmm-border">
				...
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="wms-submit" value="<?php _e('change active WMS layers','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change active WMS layers for the selected markers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;text-align:center;" class="lmm-border">
				...
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="mapsize-submit" value="<?php _e('change mapsize','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the map size for the selected markers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;text-align:center;" class="lmm-border">
				...
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="zoom-submit" value="<?php _e('change zoom','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the zoom level for the selected markers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;text-align:center;" class="lmm-border">
				...
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="controlbox-submit" value="<?php _e('change controlbox status','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the controlbox status for the selected markers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;text-align:center;" class="lmm-border">
				...
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="panel-submit" value="<?php _e('change panel status','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the panel status for the selected markers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;text-align:center;" class="lmm-border">
				...
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="icon-submit" value="<?php _e('update icon','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the icon for the selected markers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;text-align:center;" class="lmm-border">
				...
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="openpopup-submit" value="<?php _e('change popup status','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the popup status for the selected markers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;text-align:center;" class="lmm-border">
				...
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="popuptext-submit" value="<?php _e('change popup text','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the popup text for the selected markers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;text-align:center;" class="lmm-border">
				...
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="gpx-url-submit" value="<?php _e('change URL to GPX track','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the URL to GPX track for the selected markers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>		
		<tr>
			...
			<td style="vertical-align:middle;text-align:center;" class="lmm-border">
				...
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="gpx-panel-submit" value="<?php _e('change GPX panel status','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the GPX panel status (for markers with set GPX URL only) for the selected markers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
	</table>
	...
	<table class="widefat fixed" style="width:auto;">
		...
		<tr>
			...
			<td style="vertical-align:middle;" class="lmm-border">
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="basemap-layer-submit" value="<?php _e('change basemap for all layers','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the basemap for all layers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;" class="lmm-border">
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="overlays-layer-submit" value="<?php _e('change overlay status for all layers','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the overlay status for all layers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;" class="lmm-border">
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="wms-layer-submit" value="<?php _e('change active WMS layers for all layers','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change active WMS layers for all layers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;" class="lmm-border">
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="mapsize-layer-submit" value="<?php _e('change mapsize for all layers','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the map size for all layers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;" class="lmm-border">
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="zoom-layer-submit" value="<?php _e('change zoom for all layers','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the zoom level for all layers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;" class="lmm-border">
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="controlbox-layer-submit" value="<?php _e('change controlbox status for all layers','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the controlbox status for all layers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;" class="lmm-border">
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="panel-layer-submit" value="<?php _e('change panel status for all layers','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the panel status for all layers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;" class="lmm-border">
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="listmarkers-layer-submit" value="<?php _e('change list marker-status for all layers','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the list marker-status for all layers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;" class="lmm-border">
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="listmarkers-clustering-submit" value="<?php _e('change clustering status for all layers','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the clustering-status for all layers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
			...
			<td style="vertical-align:middle;text-align:center;" class="lmm-border">
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="gpx-url-layer-submit" value="<?php _e('change URL to GPX track','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the URL to GPX track for all layers? (cannot be undone)','lmm') ?>')" />
				</form>
			</td>
		</tr>
		<tr>
	...
	<table class="widefat fixed" style="width:auto;">
		...
		<tr>
			...
			<td>
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="mass_asign-submit" value="<?php _e('update ID','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to change the ID?','lmm') ?>')" />
			</td>
		</tr>
	</table>
	</form>
	...
	*/
	...
	<table class="widefat fixed" style="width:auto;">
		...
		<tr>
			...
			<td>
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="mass_delete_from_layer-submit" value="<?php _e('clear cache','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to clear the QR code images cache? (cannot be undone)','lmm') ?>')" />
			</td>
		</tr>
	</table>
	</form>
	...
	<table class="widefat fixed" style="width:auto;">
		...
		<tr>
			...
			<td>
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="mass_delete_from_layer-submit" value="<?php _e('delete all markers from selected layer','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to delete all markers from the selected layer? (cannot be undone)','lmm') ?>')" />
			</td>
		</tr>
	</table>
	</form>
	...
	<table class="widefat fixed" style="width:auto;">
		...
		<tr>
			...
			<td>
				<input style="font-weight:bold;" class="button button-primary" type="submit" name="mass_delete_all_markers" value="<?php _e('delete all markers from all layers','lmm') ?> &raquo;" onclick="return confirm('<?php _e('Do you really want to delete all markers from all layers? (cannot be undone)','lmm') ?>')" />
			</td>
		</tr>
	</table>
	</form>
